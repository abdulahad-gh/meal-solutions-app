...
const Header = () => {
    return (
        <header className='h-screen'>
            ...
            <img className='absolute left-0 top-0 hero-overlay object-cover bg-opacity-100' src={BannerImg} alt="banner" />

            <div className='absolute top-[50%] text-white left-[50%] translate-x-[-50%] translate-y-[-50%] text-center '>
                <div className='hero-overlay bg-opacity-50 px-24 pt-12 rounded-3xl'>
